...
ranking_league_repository = MongoDBRepository('ranking_league', RankingLeagueEntity, RankingLeagueModel)
...
league_service = LeagueService(league_repository, race_league_repository, ranking_league_repository, race_info_repository)
